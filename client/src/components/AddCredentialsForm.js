// client/src/components/AddCredentialsForm.js
...
function AddCredentialsForm({ userOU, userDivision, userRole }) {
  ...
  const handleAddCredentials = async (e) => {
    ...
    if (userRole === 'admin' || (userOU === selectedOU && userDivision === selectedDivision)) {
      ...
      console.error('Permission denied. You can only add credentials to your assigned OU and division.');
      alert('Permission denied. You can only add credentials to your assigned OU and division.');
    }
  };
